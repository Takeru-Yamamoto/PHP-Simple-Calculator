...
use SimpleCalculator\Proxy\CalculatorManager;
 ...
 * 
 * @method static \SimpleCalculator\Interface\CalculatorInterface make()
 * 
 ...
 * 
 * @see \SimpleCalculator\Proxy\Interface\ManagerInterface
 */
class Calculator extends StaticProxy
{
    /** 
     * CalculatorManagerの実クラス名を取得する
     * 
     * @return string 
     */
    public static function getRealInstanceName(): string
    {
        return CalculatorManager::class;
    }
}
